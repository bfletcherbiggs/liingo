defmodule Liingoew.Web.ProductController do
  use Liingoew.Web, :controller

  alias Liingoew.Query
  ...
  def index(conn, %{"search_product" => search_params} = _params) do
    ...
    products = Repo.all(SearchProduct.search(Liingoew.Query.Product.products_with_master_variant, search_params))
