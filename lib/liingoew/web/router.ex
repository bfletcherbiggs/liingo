defmodule Liingoew.Web.Router do
  use Liingoew.Web, :router
  ...
  pipeline :admin_browser_auth do
    plug Guardian.Plug.VerifySession
    plug Guardian.Plug.LoadResource
    plug Liingoew.Plugs.AdminAccessRequired
  end
  ...
  scope "/", Liingoew.Web do
    pipe_through [:browser, :browser_auth, Liingoew.Plugs.Cart]
  ...
  scope "/admin", Liingoew.Web.Admin, as: :admin do
  ...
  scope "/api", Liingoew.Web.Api do
    pipe_through [:api, :api_auth, Liingoew.Plugs.Cart]
    get "/cart", CartController, :show
  end

  use Liingoew.Web.RouteExtender
