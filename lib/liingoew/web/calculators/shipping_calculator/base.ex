defmodule Liingoew.ShippingCalculator.Base do
  @callback calculate_shipping(Liingoew.ShippingUnit.t) :: any
  @callback applicable?(Liingoew.ShippingUnit.t) :: any
  @callback shipping_rate(Liingoew.ShippingUnit.t) :: any
  ...
  def add_shipping_methods(shipping) do
    quote location: :keep do
      ...
      @behaviour Liingoew.ShippingCalculator.Base
