defmodule Liingoew.Web.CartChannel do
  use Liingoew.Web, :channel
  ...
  def send_out_of_stock_notification(id) do
    Liingoew.Endpoint.broadcast "cart:#{id}", "new_notification", %{msg: "some products in your cart are out of stock"}
  end
end
