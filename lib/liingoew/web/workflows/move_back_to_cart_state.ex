defmodule Liingoew.Workflow.MoveBackToCartState do
  ...
  def steps(order) do
    ...
    |> Multi.delete_all(:delete_shipping_address, Liingoew.Query.OrderShippingAddress.for_order(order))
    |> Multi.delete_all(:delete_billing_address, Liingoew.Query.OrderBillingAddress.for_order(order))
    |> Multi.update(:update_state, Liingoew.Order.state_changeset(order, %{state: "cart"}))
  end
