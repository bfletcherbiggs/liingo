defmodule Liingoew.Workflow.UpdateQuantityInCart do
  ...
  def steps(line_item, variant, quantity) do
    ...
    |> Multi.append(Liingoew.Workflow.CheckVariantAvailability.steps(variant, requested_quantity, changeset))
  ...
  defp line_item_update_quantity_changeset(line_item, quantity) do
    Liingoew.LineItem.quantity_changeset(line_item, %{add_quantity: quantity})
  end
