defmodule Liingoew.Workflow.Checkout.Address do
  alias Ecto.Multi
  ...
  def changeset_for_step(order, params \\ %{}) do
    Liingoew.Order.address_changeset(order, params)
  end
  ...
  defp post_transition(repo, changes) do
    Multi.new()
    |> Multi.append(Liingoew.Workflow.CreateShipmentUnits.steps(repo, changes.order))
    |> repo.transaction
  end
end
