defmodule Liingoew.CheckoutManager do
  ...
  @checkout_forward_modules Application.get_env(:Liingoew, :checkout_forward_workflow)
  @next_changeset_module %{
    "cart"     => @checkout_forward_modules[:cart_to_address]     || Liingoew.Workflow.Checkout.Address,
    "address"  => @checkout_forward_modules[:address_to_shipping] || Liingoew.Workflow.Checkout.Shipping,
    "shipping" => @checkout_forward_modules[:shipping_to_tax]     || Liingoew.Workflow.Checkout.Tax,
    "tax"      => @checkout_forward_modules[:tax_to_payment]      || Liingoew.Workflow.Checkout.Payment
  }
  ...
  @checkout_reverse_modules Application.get_env(:Liingoew, :checkout_reverse_workflow)
  @back_workflows %{
    "cart"     => @checkout_reverse_modules[:back_to_cart]     || Liingoew.Workflow.MoveBackToCartState,
    "address"  => @checkout_reverse_modules[:back_to_address]  || Liingoew.Workflow.MoveBackToAddressState,
    "shipping" => @checkout_reverse_modules[:back_to_shipping] || Liingoew.Workflow.MoveBackToShippingState,
    "tax"      => @checkout_reverse_modules[:back_to_tax]      || Liingoew.Workflow.MoveBackToTaxState
  }
