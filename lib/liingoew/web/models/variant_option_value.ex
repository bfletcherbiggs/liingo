defmodule Liingoew.VariantOptionValue do
  use Liingoew.Web, :model

  schema "variant_option_values" do
    field :option_type_id, :integer

    belongs_to :variant, Liingoew.Variant
    belongs_to :option_value, Liingoew.OptionValue
  ...
  def remove_if_not_in_valid_product_option_type(changeset) do
    if changeset.data.id do
      variant = Liingoew.Repo.get_by(Liingoew.Variant, id: changeset.data.variant_id)
                              |> Liingoew.Repo.preload(product: :product_option_types)
